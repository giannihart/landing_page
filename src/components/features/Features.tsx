...
const features = [
  {
    ...
    description: 'Instantly generate clean, structured API documentation from your code—no manual writing needed',
    icon: (
  ...
  {
    title: 'MCP Server',
    description: 'Enable AI agents to seamlessly read and interpret your API documentation, facilitating intelligent, automated interactions.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    title: 'Text Editor',
    description: 'Effortlessly editing and formatting of the docs, ensuring professional-quality output with minimal effort.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    description: 'Test every API before using it on your production environment.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    title: 'Custom Themes',
    description: 'Add your brand\'s logo, color schemes, and style to the docs to make them yours.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    title: 'Chat Assist Search',
    description: 'Unsure what you are looking for? Use our Chat Assistant to help you find the exact API.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
