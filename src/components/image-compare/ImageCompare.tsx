...
const ImageCompare: React.FC<ImageCompareProps> = ({ 
  ...
  return (
    <section className="relative py-24 bg-background overflow-hidden" id="product">
        ...
        <div className="mt-6 text-center">
          <div className="flex justify-between max-w-4xl mx-auto px-4">
            <div className="flex items-center">
              ...
              <span className="text-base font-bold text-foreground">Slide left to see Standard API Docs</span>
            </div>
            <div className="flex items-center">
              <span className="text-base font-bold text-foreground">Slide right to see Devscribe API Docs</span>
